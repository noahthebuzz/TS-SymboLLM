...
EXAMPLES = {
    "temperature": os.path.join(BASE_DIR, "examples", "data", "temperature.csv"),
    "cpu": os.path.join(BASE_DIR, "examples", "data", "cpu_multi.json"),
}
...
def list_examples() -> None:
    ...
    for name, path in EXAMPLES.items():
        print(f"  - {name}: {os.path.relpath(path, BASE_DIR)}")
